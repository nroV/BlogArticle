                ...
                <div class="modal-content d-flex justify-content-center">
                    ...
                    <div class="modal-body p-3 border-0">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-col">
                                    <input type="reset" class="btn btn-danger my-1 text-center" name="btn_po"
                                        value="Discard">
                                    <input type="submit" class="btn my-1 text-center text-white" name="btn_post"
                                        value="Save change" style="background-color:#1E2B58">
                                </div>
                            </div>
                ...
                <div class="profile container d-flex flex-column align-items-center">
                    ...
                    <div class="img-profile my-5">
                        <img src="
                            ...
                            echo $imageprofile = $row['Profile_Image'];
        ...
        <div class="container-fluid p-0 ">
            <ul class="nav nav-tabs justify-content-center p-0" id="myTab" role="tablist"
                ...
                <li class="nav-cate nav-item" role="presentation">
                    <button class="btn-category  d-md-block d-none nav-link lead font-weight-bold text-white disabled"
                        id="home-tab" data-bs-toggle="tab" data-bs-target="" type="" role="tab" aria-controls="home"
                ...
                <li class="nav-cate nav-item" role="presentation">
                    <button class="btn-category nav-link lead active text-dark font-weight-bold" id="profile-tab"
                        data-bs-toggle="tab" data-bs-target="<?php echo "./animal.php?UserID=$userid&mypage=1" ?>"
                        type="button" role="tab" aria-controls="profile" aria-selected="false">
                        <!-- animal category link -->
                        <?php
                        echo " <a href='./animal.php?UserID=$userid&mypage=1' class='text-decoration-none text-dark'>    
                             Animal </a> ";
                        ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-12 text-left">
                    <div class="header">
                        ...
                        <p class="display-4 lead font-weight-bold text-md-left">Animal
                        </p>
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="input-group input-group-lg my-5" style="border:0px;">
                                ...
                                <input type="search" class="form-control rounded" placeholder="Search your blog here"
                                    ...
                                    name="search" />
                                <input type="submit" class="input-group-text d-md-block d-none" name="btn_searching"
