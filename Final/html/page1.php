...
<div class="d-none justify-content-around my-3">
                ...
                <div class="profile container d-flex flex-column align-items-center">
                    ...
                    <div class="img-profile my-5">
                        <img src="
                           ...
                           echo trim($imageprofile = $row['Profile_Image']);
    ...
    <section class="topbar sticky-top">
        ...
        <div class="container-fluid p-0 d-none d-md-block">
            <ul class="nav nav-tabs justify-content-center p-0" id="myTab" role="tablist"
                ...
                <!-- tabbarview top -->
                <li class="nav-cate nav-item d-md-block d-none" role="presentation">
                    <button class="btn-category nav-link lead font-weight-bold text-white disabled" id="home-tab"
                        data-bs-toggle="tab" data-bs-target="<?php echo "./page1.php?UserID=$userid&mypage=1" ?>"
                        type="" role="tab" aria-controls="home" aria-selected="true">Category | </button>
                </li>
                <li class="nav-cate nav-item" role="presentation">
                    <button class="btn-category nav-link active lead font-weight-bold text-dark" id="home-tab"
                        data-bs-toggle="tab" data-bs-target="<?php echo "./animal.php?UserID=$userid&mypage=1" ?>"
                        type="button" role="tab" aria-controls="home" aria-selected="true">
                        <?php
                        echo " <a href='./page1.php?UserID=$userid&mypage=1' class='text-decoration-none text-dark'>    
                           Technology </a> ";
                        ?></button>
                </li>
                <li class="nav-cate nav-item" role="presentation">
                ...
                <li class="nav-cate nav-item" role="presentation ">
                    <button class="btn-category nav-link lead text-white lead" id="contact-tab" data-bs-toggle="tab"
                        ...
                        role="tab" aria-controls="contact" aria-selected="false"> <?php
                        echo " <a href='./landscape.php?UserID=$userid&mypage=1' class='text-decoration-none text-white'>    
                             landscape </a> ";
                        ?></button>
                </li>
                <li class="nav-cate nav-item" role="presentation ">
                    <button class="btn-category nav-link lead text-white" id="contact-tab" data-bs-toggle="tab"
                        data-bs-target="<?php echo "./lother.php?UserID=$userid&mypage=1" ?>" type="button" role="tab"
                        aria-controls="contact" aria-selected="false">
                        <?php
                        echo " <a href='./other.php?UserID=$userid&mypage=1' class='text-decoration-none text-white'>    
                             other </a> ";
                        ?>
                    </button>
                </li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-12 text-left">
                    <div class="header">
                        ...
                        <p class="display-4 lead font-weight-bold text-md-left">Technology
                        </p>
                        <p class="lead font-weight-lighter">whether you're looking for stunning macro-photography or
                            shots of complex architectural shapes Find out about his miraculous story of rescue,
                            treatment and recovery here any article, news piece, or guide that's published in the blog
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="input-group input-group-lg my-5 p-md-0" style="border:0px;">
                                ...
                                <input type="search" class="form-control rounded" placeholder="Search your blog here"
                                    aria-label="Search" aria-describedby="search-addon" style="width:400px;"
                                    name="search" />
                                <input type="submit" class="input-group-text d-md-block d-inline-flex d-none    " name="btn_searching"
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center" style="background-color:#e9ecef  ;">
                                ...
                                echo "   <li class='page-item 'text-dark>
                                    <a class='page-link text-dark' href='./page1.php?UserID=$userid&mypage=" . $nextpage . "'> Previous <span class='sr-only'>(current)</span></a>
                                </li>";
                                ...
                                for ($i = 1; $i <= $totalpage; $i++) {
                                  ...
                                  echo "<li class='page-item " . $checkactive . "' >
                                    <a class='" . $checkactive . " page-link' href='./page1.php?UserID=$userid&mypage=" . $i . "'>" . $i . " <span class='sr-only'>(current)</span></a>
                                  </li>";
                                    }
                                ...
                                echo "   <li class='page-item ' style='background-color:#1E2B58;'>
                                    <a class='page-link text-dark' href='./page1.php?UserID=$userid&mypage=" . $nextpage . "'> Next <span class='sr-only'>(current)</span></a>
                                </li>";
    ...
    <!-- pagination -->
    <div class="d-block d-md-none here container mb-5">
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center" style="background-color:#e9ecef  ;">
                <?php
