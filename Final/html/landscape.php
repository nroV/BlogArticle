    ...
    <section class="topbar sticky-top">
        ...
        <div class="container-fluid p-0 d-none d-md-block">
            <ul class="nav nav-tabs justify-content-center p-0" id="myTab" role="tablist"
                ...
                <li class="nav-cate nav-item" role="presentation ">
                    <button class="btn-category nav-link lead text-white lead active font-weight-bold" id="contact-tab"
                        data-bs-toggle="tab" data-bs-target="<?php echo "./landscape.php?UserID=$userid&mypage=1" ?>"
                        type="button" role="tab" aria-controls="contact" aria-selected="false">
                        <?php
                        echo " <a href='./landscape.php?UserID=$userid&mypage=1' class='text-decoration-none text-dark'>    
                             landscape </a> ";
                        ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-12 text-left">
                    <div class="header">
                        ...
                        <p class="display-4 lead font-weight-bold text-md-left">Landscape
                        </p>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center" style="background-color:#e9ecef  ;">
                                ...
                                echo "   <li class='page-item 'text-dark>
                                    <a class='page-link text-dark' href='./landscape.php?UserID=$userid&mypage=" . $nextpage . "'> Previous <span class='sr-only'>(current)</span></a>
                                </li>";
                                ...
                                for ($i = 1; $i <= $totalpage; $i++) {
                                    ...
                                    <a class='" . $checkactive . " page-link' href='./landscape.php?UserID=$userid&mypage=" . $i . "'>" . $i . " <span class='sr-only'>(current)</span></a>
                                  </li>";
                                    }
                               ...
                               if($nextpage > $totalpage){
                                ...
                                echo "   <li class='page-item ' style='background-color:#1E2B58;'>
                                    <a class='page-link text-dark' href='./landscape.php?UserID=$userid&mypage=" . $nextpage . "'> Next <span class='sr-only'>(current)</span></a>
                                </li>";
